...
## read
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1beta2.watch.prioritylevelconfigurations.get
...
## write
  ...
  | Parameter | Description |
  | --------- | ----------- |
  | `body` | #&#x2F;definitions&#x2F;io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfiguration |
